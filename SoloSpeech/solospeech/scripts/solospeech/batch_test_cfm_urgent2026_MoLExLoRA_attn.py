...
parser.add_argument('--save-dir', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/30hour/base_solospeech_tse_cfm_urgent2026_MoLExLoRA_topK_3_r_8_alpha_16_lr_e-4_loss_switch_coef_e-2_loss_orth_coef_1.0_attn_30h_epoch199_denoised/')
...
parser.add_argument('--tsr-ckpt', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/30hour/base_solospeech_tse_cfm_urgent2026_MoLExLoRA_topK_3_r_8_alpha_16_lr_e-4_loss_switch_coef_e-2_loss_orth_coef_1.0_attn_30h_ckpt/199.pt')
...
if __name__ == '__main__':
    ...
    if use_molex:
        ...
        targets = meta.get("molex_targets", "mlp.w1,mlp.w2,attn.to_q,attn.to_k,attn.to_v,attn.proj")
