...
parser.add_argument('--save-dir', type=str, default='/export/fs05/hwang258/enhance/SoloSpeech/solospeech/test_source1_reverberent/')
parser.add_argument('--input_dir', type=str, default='/export/fs05/tcao7/maskGIT/test/source1_reverberent/')
...
parser.add_argument('--tsr-ckpt', type=str, default='/export/fs05/hwang258/enhance/SoloSpeech/solospeech/base_solospeech_tse_ckpt/150.pt')
...
if __name__ == '__main__':
    ...
    for input_audio in tqdm(input_audios):
        ...
        with torch.no_grad():
            ...
            save_audio(os.path.join(args.save_dir, savename), 16000, tsr_pred)
