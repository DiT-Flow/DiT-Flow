...
parser.add_argument('--save-dir', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/30hour/base_solospeech_tse_cfm_urgent2026_ref_30h_epoch199_denoised')
...
# parser.add_argument('--tsr-ckpt', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/base_solospeech_tse_cfm_urgent2026_ref_12h_ckpt/199.pt')
parser.add_argument('--tsr-ckpt', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/30hour/base_solospeech_tse_cfm_urgent2026_ref_30h_ckpt/199.pt')
