...
parser.add_argument('--save-dir', type=str, default='base_solospeech_tse_cfm_urgent2026_baseline_full_epoch199_denoised')
...
parser.add_argument('--tsr-ckpt', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/base_solospeech_tse_cfm_urgent2026_baseline_full_ckpt/pretrained.pt')
