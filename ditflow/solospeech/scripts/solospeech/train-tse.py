...
# parser.add_argument('--train-reverb', type=str, default='/export/fs05/tcao7/maskGIT/train/source1_noisy_reverberent_decompressed')
...
# model configs
parser.add_argument('--diffusion-config', type=str, default='./config/SoloSpeech-tse-base3.yaml')
