...
parser.add_argument('--save-dir', type=str, default='/export/fs05/tcao7/journal2026/test/ditflow/noisy_reverberent_source1_denoised')
parser.add_argument('--input_dir', type=str, default='/export/fs05/afrumme1/stillSonicSetNormAligned16k_01_15/test/noisy_reverberent_source1/')
...
parser.add_argument('--tsr-ckpt', type=str, default='/export/fs05/tcao7/enhance/SoloSpeech/solospeech/base_solospeech_tse_compress_cfm_ckpt/199.pt')
